...
function TimelineItemComponent({
  ...
  return (
    <div ref={itemRef} className="flex relative gap-6">
      {/* Timeline dot */}
      <motion.div
        ...
        className="absolute top-2 left-4 w-4 h-4 rounded-full border-2 border-primary bg-primary"
      />
      ...
      <motion.div
        ...
        className="flex-1 p-4 ml-12 rounded-lg border border-border bg-card"
      >
        {item.date && (
